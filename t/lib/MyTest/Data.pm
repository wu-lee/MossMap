...
sub expected_csv_logs {
    return [
        "converting grid-ref to tetrad: SJ8584 -> SJ88M\n",
        "converting grid-ref to tetrad: SJ8061 -> SJ86A\n",
        "converting grid-ref to tetrad: SJ8475 -> SJ87M\n",
        "converting grid-ref to tetrad: SJ8475 -> SJ87M\n",
        "converting grid-ref to tetrad: SJ5381 -> SJ58F\n",
        "converting grid-ref to tetrad: SJ682871 -> SJ68Y\n",
        "converting grid-ref to tetrad: SJ7075 -> SJ77C\n",
        "converting grid-ref to tetrad: SJ7075 -> SJ77C\n",
        "converting grid-ref to tetrad: SJ7087 -> SJ78D\n",
        "converting grid-ref to tetrad: SJ5083 -> SJ58B\n",
        "discarding as too coarse: SJ38\n",
        "discarding as too coarse: SK09\n",
        "discarding as too coarse: SK09\n",
        "converting grid-ref to tetrad: SJ537719 -> SJ57F\n",
        "discarding as too coarse: SJ56\n",
        "converting grid-ref to tetrad: SJ7652 -> SJ75R\n",
        "converting grid-ref to tetrad: SJ7652 -> SJ75R\n",
        "converting grid-ref to tetrad: SJ9070 -> SJ97A\n",
        "converting grid-ref to tetrad: SJ6950 -> SJ65V\n",
        "discarding as too coarse: SJ46\n",
        "converting grid-ref to tetrad: SJ8586 -> SJ88N\n",
        "discarding as too coarse: SJ68\n",
        "converting grid-ref to tetrad: SJ5985 -> SJ58X\n",
        "discarding as too coarse: SJ46\n",
        "discarding as too coarse: SJ46\n",
        "discarding as too coarse: SJ97\n",
        "converting grid-ref to tetrad: SJ970740 -> SJ97S\n",
        "converting grid-ref to tetrad: SJ920780 -> SJ97J\n",
        "converting grid-ref to tetrad: SJ6284 -> SJ68H\n",
        "discarding as too coarse: SJ28\n",
        "converting grid-ref to tetrad: SJ9688 -> SJ98U\n",
        "converting grid-ref to tetrad: SJ9688 -> SJ98U\n",
        "converting grid-ref to tetrad: SJ9588 -> SJ98P\n",
        "converting grid-ref to tetrad: SJ3389 -> SJ38J\n",
        "converting grid-ref to tetrad: SJ9091 -> SJ99A\n",
        "converting grid-ref to tetrad: SJ9091 -> SJ99A\n",
        "converting grid-ref to tetrad: SJ6576 -> SJ67N\n",
        "converting grid-ref to tetrad: SJ8380 -> SJ88F\n",
        "discarding as too coarse: SJ27\n",
        "converting grid-ref to tetrad: SJ6886 -> SJ68Y\n",
        "discarding as too coarse: SJ56\n",
        "converting grid-ref to tetrad: SJ8687 -> SJ88T\n",
        "discarding as too coarse: SJ57\n",
        "discarding as too coarse: SJ57\n",
        "converting grid-ref to tetrad: SJ8572 -> SJ87L\n",
        "converting grid-ref to tetrad: SJ8572 -> SJ87L\n",
        "converting grid-ref to tetrad: SJ8587 -> SJ88N\n",
        "converting grid-ref to tetrad: SJ7578 -> SJ77P\n",
        "converting grid-ref to tetrad: SJ7578 -> SJ77P\n",
        "converting grid-ref to tetrad: SJ5671 -> SJ57Q\n",
        "converting grid-ref to tetrad: SJ3372 -> SJ37G\n",
        "converting grid-ref to tetrad: SK0173 -> SK07B\n",
        "discarding as too coarse: SJ55\n",
        "discarding as too coarse: SJ56\n",
        "discarding as too coarse: SJ97\n",
        "converting grid-ref to tetrad: SJ284840 -> SJ28X\n",
        "converting grid-ref to tetrad: SJ8067 -> SJ86D\n",
        "discarding as too coarse: SJ96\n",
        "discarding as too coarse: SJ96\n",
        "discarding as too coarse: SJ64\n",
        "discarding as too coarse: SJ29\n",
        "converting grid-ref to tetrad: SJ510831 -> SJ58B\n",
        "converting grid-ref to tetrad: SJ5482 -> SJ58L\n",
        "discarding as too coarse: SJ57\n",
        "converting grid-ref to tetrad: SJ4952 -> SJ45W\n",
        "discarding as too coarse: SJ68\n",
        "discarding as too coarse: SJ68\n",
        "converting grid-ref to tetrad: SJ682871 -> SJ68Y\n",
        "converting grid-ref to tetrad: SJ699841 -> SJ68X\n",
        "converting grid-ref to tetrad: SJ699841 -> SJ68X\n",
        "converting grid-ref to tetrad: SJ4975 -> SJ47X\n"
    ];
}
1;
